...
```{r Bridge, fig.height=40, echo=F, fig.align='center'}
...
trans_count %>% 
  ...
  theme(plot.title = element_text(hjust=0.3, vjust=0.1, color="#d1d1d1", size=25),
        plot.background = element_rect(fill="#2d2d2d"),
        axis.ticks.length = unit(0, "pt"),
        legend.position = "none") +
  guides(fill=guide_legend(title="Is transparent  ")) + 
  annotate(geom="text", x=1.9, y=20, label="Transparent", size=7, color="white") + 
  annotate(geom="text", x=1.9, y=125, label="Non-transparent", size=7, color="white")
```
